...
//$kd = $_GET['idmasjid'];
if(isset($_GET['judul_audio'])){
 $nama=$_GET['judul_audio'];

}

koneksi_buka();
$query = mysql_query('SELECT kj.*,mj.nama_masjid,mj.alamat_masjid,mj.contact_masjid FROM audio kj, masjid mj where kj.id_masjid = mj.id_masjid and kj.judul_audio LIKE "%'.$nama.'%" ORDER BY id_audio desc');
$json  = '{"audio": [';
...
"url_audio":"https://onlinecashier.id/infokajianislami/assets/audio/file/'.$row['file_audio'].'"},';
}
