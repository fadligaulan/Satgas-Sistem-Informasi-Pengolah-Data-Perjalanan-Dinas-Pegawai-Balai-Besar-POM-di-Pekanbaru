...
if(isset($_GET['id_streaming'])){
 $kode=$_GET['id_streaming'];

}


koneksi_buka();
$query = mysql_query('SELECT kj.*,mj.nama_masjid,mj.alamat_masjid,mj.contact_masjid FROM streaming kj, masjid mj where kj.id_masjid = mj.id_masjid and kj.id_streaming="'.$kode.'"');
$json  = '{"streaming": [';
