...
koneksi_buka();
$query = mysql_query('SELECT kj.*,mj.nama_masjid,mj.alamat_masjid,mj.contact_masjid FROM kajian kj, masjid mj where kj.id_masjid = mj.id_masjid and kj.id_kajian="'.$kode.'"');
$json  = '{"kajian": [';
