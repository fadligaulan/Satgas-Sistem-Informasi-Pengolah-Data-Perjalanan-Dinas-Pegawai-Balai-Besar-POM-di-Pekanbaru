...
koneksi_buka();
$query = mysql_query('SELECT kj.*,mj.nama_masjid,mj.alamat_masjid,mj.contact_masjid FROM video kj, masjid mj where kj.id_masjid = mj.id_masjid and kj.id_video="'.$kode.'"');
$json  = '{"video": [';
...
"url_video":"https://onlinecashier.id/infokajianislami/assets/video/file/'.$row['url_video'].'"},';
}
