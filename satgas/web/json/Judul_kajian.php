...
//$kd = $_GET['idmasjid'];
if(isset($_GET['judul_kajian'])){
 $nama=$_GET['judul_kajian'];

}

koneksi_buka();
$query = mysql_query('SELECT kj.*,mj.nama_masjid,mj.alamat_masjid,mj.contact_masjid FROM kajian kj, masjid mj where kj.id_masjid = mj.id_masjid and kj.judul_kajian LIKE "%'.$nama.'%"  ORDER BY id_kajian desc');
$json  = '{"kajian": [';
