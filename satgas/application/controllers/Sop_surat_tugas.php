...
class Sop_surat_tugas extends MY_Controller {
   ...
   {
            $data['pageTitle'] = 'SOP Surat Tugas';
            $data['pageContent'] = $this->load->view('sop_surat_tugas', $data, TRUE);
    ...
    //     $this->form_validation->set_rules('nip', 'NIP Sop_surat_tugas', 'required');
    //     $this->form_validation->set_rules('nama_pegawai', 'Nama Sop_surat_tugas', 'required');
    ...
    public function insert() 
    {
        $this->form_validation->set_rules('nip', 'NIP Sop_surat_tugas', 'required|is_unique[pegawai.nip]');
        $this->form_validation->set_rules('nama_pegawai', 'Nama Sop_surat_tugas', 'required|is_unique[pegawai.nama_pegawai]');
        $this->form_validation->set_rules('id_pangkat', 'Pangkat', 'required');
        $this->form_validation->set_rules('id_jabatan', 'Jabatan', 'required');
