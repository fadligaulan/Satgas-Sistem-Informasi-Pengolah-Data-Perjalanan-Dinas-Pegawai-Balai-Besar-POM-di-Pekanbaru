...
<body>
 ...
 <table width="100%">
    <tr>
        <td width=100 align="center"><img src="<?php echo base_url('assets/images/logo/head.png'); ?>" width="100%"></td>             
    </tr>
</table> 
...
<!--<table border=0 cellspacing=0 cellpadding=0 >-->
<!--    <tr height=17 >-->
<!--        <td width=397 align=left> <br></td>-->
<!--        <td width=33  align=left bgcolor=#ffffff><font style=font-size:10pt face="Arial" color=#000000><?php echo $surat->jabatan1; ?></font></td>-->
...
<!--    <tr height=17 >-->
<!--        <td width=397 align=left> <br></td>-->
<!--        <td width=33  align=left valign="top" bgcolor=#ffffff><font style=font-size:10pt face="Arial" color=#000000><?php echo $surat->jabatan4; ?></font></td>-->
